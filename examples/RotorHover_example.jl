...
# AUTHORSHIP
  ...
  * License         : MIT
=###############################################################################
#include(joinpath("/home/fynn/Repositories/BladeWakeOPT/01_single_turbine_simulation/RotorHover_example.jl"))
...
run_name        = "RotorHover_example"      # Name of this simulation
